                            ...
                            for ($i=0;$i<sizeof($table_items);$i++){
                                if ($table_items[$i]['isvalid']){
                                    ...
                                    if (isset($table_items[$i]['foreign_table']) &&
                                        ...
                                        if ($table_items[$i]['in_select']) $_sqlArr['SQL_SELECT'][] = $table_items[$i]['db_field'];
                                    }
